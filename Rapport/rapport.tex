...
Il nous faut maintenant un modèle fonctionnel. Le but est de d'abord faire un plateau de jeu. Ceci se fait principalement dans la classe \texttt{BoardModel} du fichier \texttt{boardmodel.hpp}. \\

Les rangées sont des objets de classe \texttt{Lane}, classe qui est définie dans le fichier \texttt{lanes.hpp}. La classe \texttt{BoardModel} contient alors un vecteur de pointeurs vers des objets \texttt{Lane}. 
% To be continued
